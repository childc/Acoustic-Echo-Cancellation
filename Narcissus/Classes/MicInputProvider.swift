...
public class MicInputProvider {
    ...
    @objc func engineConfigurationChange(notification: Notification) {
        print("engineConfigurationChange - \(notification)")
